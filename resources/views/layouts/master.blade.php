...
<head>
    ...
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/frontend/css/swiper-bundle.min.css')}}?v={{ time() }}"
          rel="stylesheet" type="text/css"/>
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/frontend/css/venobox.min.css')}}?v={{ time() }}"
          rel="stylesheet" type="text/css"/>
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/global/css/nice-select.css')}}?v={{ time() }}"
          rel="stylesheet" type="text/css"/>
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/global/css/select2.min.css')}}?v={{ time() }}"
          rel="stylesheet" type="text/css"/>
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/global/css/aos.css')}}?v={{ time() }}" rel="stylesheet"
          type="text/css"/>
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/frontend/css/root.css')}}?v={{ time() }}" rel="stylesheet"
          type="text/css"/>
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/frontend/css/common.css')}}?v={{ time() }}" rel="stylesheet"
          type="text/css"/>
    <link nonce="{{ csp_nonce() }}" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.15.10/dist/sweetalert2.min.css"
          rel="stylesheet" type="text/css"/>
    @if(request()->routeIs('user.*'))
        <link nonce="{{ csp_nonce() }}" href="{{asset('assets/frontend/css/dashboard.css')}}?v={{ time() }}"
              rel="stylesheet" type="text/css"/>
        <link nonce="{{ csp_nonce() }}" href="{{asset('assets/global/css/simplebar.min.css')}}?v={{ time() }}"
              rel="stylesheet" type="text/css"/>
    @else
        <link nonce="{{ csp_nonce() }}" href="{{asset('assets/frontend/css/style.css')}}?v={{ time() }}"
              rel="stylesheet" type="text/css"/>
    @endif
    ...
    <link nonce="{{ csp_nonce() }}" href="{{asset('assets/global/css/toastr.css')}}?v={{ time() }}" rel="stylesheet"
          type="text/css"/>
...
<main class="main" id="main">
    @if(request()->routeIs('user.*'))
        <section
            class='main-wrapper {{request()->routeIs("user.plan") || request()->routeIs("user.profile") ? "px-25 pt-25" :"" }}'>
            @yield('content')
        </section>
    @else
        @yield('content')
...
<script nonce="{{ csp_nonce() }}"
        src="https://cdn.jsdelivr.net/npm/sweetalert2@11.15.10/dist/sweetalert2.all.min.js"></script>
@if(request()->routeIs('user.*'))
