                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-inner">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" id="affiliate_commission" placeholder="{{translate('Enter commission')}}" step="0" type="number" min="0" max="100" name="affiliate_commission" value="{{old('affiliate_commission')}}">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="socailConfig">
                                        ...
                                        aria-controls="socailSection">
                                            ...
                                            <i
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{{translate('Social Platform Configuration')}}" class="ms-1  pointer las la-question-circle  text--danger"></i>
                                        </button>
                                    </h2>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap gap-4 border py-2 px-3 rounded-2">
                                                            <div class="d-flex align-items-center gap-2 mb-1 pointer">
                                                                ...
                                                                <label for="webhook_access" class="form-check-label mb-0">
                                                            ...
                                                            <div class="d-flex align-items-center gap-2 mb-1 pointer">
                                                                ...
                                                                <label for="schedule_post" class="form-check-label mb-0">
