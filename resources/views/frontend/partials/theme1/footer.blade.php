            ...
            <div class="row gy-5">
                @if($menus->count() > 0)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                        <h4 class="footer-title">{{ translate('Quick link') }}</h4>
                ...
                @if($pages->count() > 0)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                        <h4 class="footer-title">{{ translate('Information') }}</h4>
                        <ul class="footer-list">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        ...
                        <ul class="footer-list">
                            @foreach($services as $service)
                                <li>
                                    <a href="{{ route('service', ['slug' => make_slug($service->value->title), 'uid' => $service->uid]) }}">
                ...
                @if($blogs->count() > 0)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <h4 class="footer-title">{{ translate('Blogs') }}</h4>
                        <ul class="footer-list">
